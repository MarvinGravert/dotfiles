...
#Python. Numpy was complaining that this shoudl be in PATH
export PATH="$HOME/.local/bin:$PATH"


##virtualenv stuff https://realpython.com/python-virtual-environments-a-primer/
...
## Better python exception https://github.com/Qix-/better-exceptions
